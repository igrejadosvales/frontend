export default function Music() {
    return(
        <section className="w-full h-header bg-background-music bg-no-repeat bg-cover bg-[center_top_-10rem] text-white relative">
            ...
            <div className="max-w-screen-xl m-auto flex flex-col justify-between h-full py-10 relative z-10 px-5">
                ...
                <div className="flex flex-col gap-5">
                    <h2 className="text-3xl font-medium">Nova música: Roubou meu Coração
                    </h2>
