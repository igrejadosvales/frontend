...
export default function SprintPage() {
  return (
    <div className="bg-white flex flex-col min-h-screen font-sans">
      ...
      {/* Header (Inspired by the Reference UI) */}
      <header className="w-full bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex gap-8 font-semibold text-sm text-gray-600 uppercase">
            ...
            <a href="#percurso" className="hover:text-lime-500 transition-colors">Percurso</a>
            <a href="#info" className="hover:text-lime-500 transition-colors">Informações</a>
          </nav>

          <a href="#" className="bg-lime-500 hover:bg-lime-600 text-white font-bold py-3 px-6 rounded text-xs sm:text-sm uppercase transition-colors shadow-md">
            INSCRIÇÕES 2026
          </a>
        </div>
      </header>
      ...
      <main className="flex-1 w-full flex flex-col relative" id="home">
        ...
        <section className="w-full py-20 px-4 sm:px-6 lg:px-8 bg-white" id="info">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-neutral-50 rounded-xl p-8 border border-neutral-100 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow">
                ...
                <h3 className="text-gray-500 text-xs sm:text-sm font-bold uppercase mb-2">Data da Corrida</h3>
                <p className="text-2xl sm:text-3xl font-black text-gray-800">11 de Abril</p>
              </div>
              ...
              <div className="bg-neutral-50 rounded-xl p-8 border border-neutral-100 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow">
                ...
                <h3 className="text-gray-500 text-xs sm:text-sm font-bold uppercase mb-2">Concentração</h3>
                <p className="text-2xl sm:text-3xl font-black text-gray-800">07:00</p>
              </div>
              ...
              <div className="bg-neutral-50 rounded-xl p-8 border border-neutral-100 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow">
                ...
                <h3 className="text-gray-500 text-xs sm:text-sm font-bold uppercase mb-2">Largada</h3>
                <p className="text-2xl sm:text-3xl font-black text-gray-800">07:30</p>
              </div>
              ...
              <div className="bg-neutral-50 rounded-xl p-8 border border-neutral-100 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow">
                ...
                <h3 className="text-gray-500 text-xs sm:text-sm font-bold uppercase mb-2">Quilometragem</h3>
                <p className="text-2xl sm:text-3xl font-black text-gray-800">4.800m</p>
        ...
        {/* Estrutura do Evento */}
        <section className="w-full py-20 px-4 sm:px-6 lg:px-8 bg-neutral-100 border-t border-gray-200" id="estrutura">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black tracking-tight text-lime-950 uppercase">
                Estrutura do Evento
              ...
              <p className="mt-6 text-lg text-gray-600 max-w-2xl mx-auto">
                Preparamos uma estrutura completa e segura para você focar no que importa: a sua corrida e o nosso propósito.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-lg border border-gray-100 hover:-translate-y-1 transition-transform">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-gray-800 uppercase leading-tight">
                    Gazebos <span className="text-lime-600 text-base sm:text-lg block sm:inline mt-1 sm:mt-0">(3 unidades)</span>
                  </h3>
                </div>
                <ul className="space-y-4">
                  <li className="flex items-center gap-3 text-base sm:text-lg text-gray-700 font-medium">
                    <svg className="w-6 h-6 text-green-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>
                    Entrega de kits
                  </li>
                  <li className="flex items-center gap-3 text-base sm:text-lg text-gray-700 font-medium">
                    <svg className="w-6 h-6 text-green-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>
              ...
              <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-lg border border-gray-100 hover:-translate-y-1 transition-transform">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-gray-800 uppercase leading-tight">Presença de Apoio</h3>
                </div>
                <ul className="space-y-4">
                  <li className="flex items-center gap-3 text-base sm:text-lg text-gray-700 font-medium">
                    <svg className="w-6 h-6 text-green-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"></path></svg>
        ...
        <section className="w-full py-20 px-4 sm:px-6 lg:px-8 bg-white" id="percurso">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black tracking-tight text-lime-950 uppercase">
                Local da Prova
        ...
        <section className="w-full py-24 px-4 bg-lime-500 text-white text-center flex flex-col items-center">
          ...
          <p className="text-xl md:text-2xl font-light mb-12 max-w-4xl mx-auto">
            Mais do que cruzar a linha de chegada, nosso objetivo é ajudar o próximo. Um evento promovido pela Igreja dos Vales para unir esporte, fé e solidariedade. Junte-se a nós nesta missão de transformar vidas!
          </p>
          <a href="#" className="bg-white hover:bg-gray-100 text-lime-500 font-bold py-4 px-10 rounded text-lg uppercase transition-colors shadow-lg">
